...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Tạo bài viết tin tức mới cho website</p>
        </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                                      ...
                                      placeholder="Nhập tóm tắt ngắn về tin tức...">{{ old('excerpt') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" 
                                      ...
                                      placeholder="Nhập nội dung chi tiết của tin tức..." required>{{ old('content') }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mb-4">
                            <label for="image_url" class="form-label fw-bold">
                                <i class="fas fa-link me-2"></i>Link hình ảnh
                            </label>
                        ...
                        <div class="mb-4">
                            <label for="image" class="form-label fw-bold">
                                <i class="fas fa-upload me-2"></i>Hoặc upload hình ảnh
                            </label>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label fw-bold" for="is_published">
                                    <i class="fas fa-eye me-2 text-success"></i>Xuất bản ngay
                                </label>
